...
# Run on console streamlit run dash_interativa.py
...
fig_mensal = px.line(receita_mensal,
                             x='Mes',
                             y='Preço',
                             markers=True,
                             range_y=(receita_mensal['Preço'].min()*0.95, receita_mensal['Preço'].max()*1.05),
                             color='Ano',
                             line_dash='Ano',
                             title='Receita Mensal'
                             )
fig_mensal.update_layout(yaxis_title='Receita')
